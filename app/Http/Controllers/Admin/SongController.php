...
class SongController extends Controller
{
    ...
    public function create()
    {
        ...
        $top100s = Top100::orderBy('name_top100','ASC')->select('id','name_top100')->get();
        return view('admin.song.create',compact('cats','artists','areas','top100s'));
    }
    /**
    ...
    public function store(StoreRequest $request)
    {
        ...
        if(Song::create($request->all())){
            return redirect()->route('admin.song.index')->with('success','Thêm mới bài hát thành công!');
        }
    }
    ...
    public function edit($id)
    {
        ...
        $areas = Area::orderBy('name_area','ASC')->select('id','name_area')->get();
        $top100s = Top100::orderBy('name_top100','ASC')->select('id','name_top100')->get();
        return view('admin.song.edit',compact('song','cats','artists','areas','top100s'));
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        $song->update($request->only('name_song','top100_id','category_id','image_song','image_bannersong','link_mp3','link_lyrics','artist_id','area_id','prioty','status'));
        return redirect()->route('admin.song.index')->with('success','Cập nhật bài hát thành công!');
    }
    ...
    public function destroy($id)
    {
        ...
        $song->delete();
        return redirect()->route('admin.song.index')->with('success','Xóa bài hát thành công!');
    }
}
