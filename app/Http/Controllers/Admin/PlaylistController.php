...
class PlaylistController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(Playlist::create($request->all())){
            return redirect()->route('admin.playlist.index')->with('success','Thêm mới playlist thành công!');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.playlist.index')->with('success','Cập nhật playlist thành công!');
    }
    ...
    public function destroy($id)
    {
        ...
        if($playlist->songs->count()>0){
            return redirect()->route('admin.playlist.index')->with('error','Playlist chứa bài hát, không thể xóa!');
        }
        else{
            ...
            $playlist->delete();
            return redirect()->route('admin.category.index')->with('success','Xóa playlist thành công!');
        }
    }
}
