...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'upload_image_gif' => 'required|mimes:gif|max:2048',
            'prioty' => 'required',
            'area_id'=>'required',
        ];
    }
    public function messages()
    {
        return [
            ...
            'upload_image_gif.required' => 'Ảnh gif không được để trống',
            'upload_image_gif.mimes' => 'Chỉ chấp nhận định dạng ảnh với đuôi .gif',
            'upload_image_gif.max' => 'Giới hạn dung lượng hình ảnh không quá 2MB',
