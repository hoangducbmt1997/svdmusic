...
@section('main')
    <div class="ms-wrapper-mobile">
            ...
            <div class="wrapper-ms-artist-banner">
                <div class="ms-artist-info ">
                    <div class="wrapper-artist-info">
                        <img class="avatar-artist" onerror="this.src='{{ url('uploads/artist/avatar_default.jpg') }}'"
                            src="{{ url('uploads/artist') }}/{{ $artist->image_artist }}" />
                        <div class="ms-artist-profile">
                            <p class="title-suggesstion ">{{ $artist->name_artist }}</p>
                            <p class="artist-story">
                                {{ $artist->description_artist ? $artist->description_artist : 'Thông tin: Đang cập nhật' }}
                                ...</p>
                        ...
                        <div class="artist-suggession-play-song">
                            ...
                            @if ($checkRegistered)
                                <a
                                    href="{{ route('home.artist.unregistered', ['id_user' => Auth::guard('customer')->user()->id, 'id_artist' => $artist->id]) }}">
                            ...
                            @else
                                ...
                                @if (Auth::guard('customer')->check())
                                    <a
                                        href="{{ route('home.artist.registered', ['id_user' => Auth::guard('customer')->user()->id, 'id_artist' => $artist->id]) }}">
                        ...
                        <div class="wrapper-suggesstion">
                            <div class="wraper-equalizer">
                                ...
                                <div class="list-music-item-info">
                                    ...
                                    >>>>>>> f88082639207a009ce99e2adcc352f7401f4ae0a
                                </div>
                                <div class="overlay"></div>
                                <img
        ...
        <<<<<<< HEAD=======<div class="ms-artist-playlist ms-content-mobile">
            <div class="ms-sugesstion-song">
                <p class="title-suggesstion">Playlist</p>
                <div class="owl-carousel carousel-suggesstion-song">
                    <div class="item">
                    ...
                    <div class="item">
                        <div class="wrapper-suggesstion">
                            ...
                            <div class="overlay"></div>
                            <img src="https://avatar-ex-swe.nixcdn.com/playlist/2018/09/13/2/6/2/f/1536805686434.jpg" />
                        </div>
                    </div>
