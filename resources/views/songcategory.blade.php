            ...
            <div class="wrapper-ms-artist-banner">
                <div class="ms-artist-info ">
                    <div class="wrapper-artist-info">
                        <img class="avatar-artist" onerror="this.src='{{ url('uploads/category/category_default.jpg') }}'"
                            src="{{ url('uploads/category') }}/{{ $category->image_gif_category }}" />
                        <div class="ms-artist-profile">
                            ...
                            <p class="artist-story">
                                {{ $category->description_artist ? $category->description_artist : 'Ngày cập nhật:' }} ...
                            </p>
                        ...
                        <div class="artist-suggession-play-song">
                            ...
                            @if ($checkRegistered)
                                <a
                                    href="{{ route('home.category.unregistered', ['id_user' => Auth::guard('customer')->user()->id, 'id_category' => $category->id]) }}">
                            ...
                            @else
                                ...
                                @if (Auth::guard('customer')->check())
                                    <a
                                        href="{{ route('home.category.registered', ['id_user' => Auth::guard('customer')->user()->id, 'id_category' => $category->id]) }}">
