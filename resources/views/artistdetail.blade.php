                ...
                <div class="ms-artist-info ">
                    <div class="wrapper-artist-info">
                        ...
                        <div class="artist-suggession-play-song">
                            ...
                            @if ($checkRegistered)
                                <a
                                    href="{{ route('artist.unregistered', ['id_user' => Auth::guard('customer')->user()->id, 'id_artist' => $artist->id]) }}">
                                    <button class="btn btn-artist-register"><i class="fas fa-check"></i>
                                        Đã quan tâm</button></a>
                            @else
                                <!--Neu chua dang ki thi ktra user dang nhap roi check-->
                                @if (Auth::guard('customer')->check())
                                    <a
                                        href="{{ route('admin.artist.registered', ['id_user' => Auth::guard('customer')->user()->id, 'id_artist' => $artist->id]) }}">
