            ...
            <div class="ms-artist-info ">
                <div class="wrapper-artist-info">
                    ...
                    <div class="artist-suggession-play-song">
                        ...
                        @if($checkRegistered)
                        <a href="{{route('artist.unregistered',['id_user'=>Auth::guard('customer')->user()->id,'id_artist'=>$artist->id])}}">
                        ...
                        <!--Neu chua dang ki thi ktra user dang nhap roi check-->
                            ...
                            <a href="{{route('admin.artist.registered',['id_user'=>Auth::guard('customer')->user()->id,'id_artist'=>$artist->id])}}">
