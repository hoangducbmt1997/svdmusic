        ...
        <div class="ms-wrapper-content-song ms-content-mobile ms-list-ranking-song">
            ...
            <div class="ms-list-song">
                <div class="wrap-list-song">
                    <ul class="list-music ">
                        <li class="list-music-item  " data-music="{{ url('uploads/mp3') }}/{{ $song->link_mp3 }}"
                            data-lrc="{{ url('uploads/lrc') }}/{{ $song->link_lyrics }}" data-name="{{ $song->name_song }}"
                            data-creator="{{ $song->artist->name_artist }}"
                            data-avatar="{{ url('uploads/image_song') }}/{{ $song->image_song }}"
                            data-img="{{ url('uploads/banner_song') }}/{{ $song->image_bannersong }}" data-index="0"
                            data-id="{{ $song->id }}">
                            ...
                            <div class="list-music-item-info">
                                <div class="avatar">
                                    ...
                                    <img onerror="this.src='{{ url('uploads/image_song/song_default.jpg') }}'"
                                        src="{{ url('uploads/image_song') }}/{{ $song->image_song }}">
                                </div>
                                <div class="item-info">
