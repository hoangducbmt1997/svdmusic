            ...
            <div class="wrapper-ms-artist-banner">
                <div class="ms-artist-info ">
                    <div class="wrapper-artist-info">
                        <img class="avatar-artist" onerror="this.src='{{ url('uploads/top100/top100_default.jpg') }}'"
                            src="{{ url('uploads/top100') }}/{{ $top100->image_gif_top100 }}" />
                        <div class="ms-artist-profile">
                            <p class="title-suggesstion ">{{ $top100->name_top100 }}</p>
                            <p class="artist-story">Mô tả: Đang cập nhật</p>
                            <p class="artist-story">Ngày cập nhật: ...</p>
                        ...
                        <div class="artist-suggession-play-song">
                            ...
                            @if ($checkRegistered)
                                <a
                                    href="{{ route('home.top100.unregistered', ['id_user' => Auth::guard('customer')->user()->id, 'id_top100' => $top100->id]) }}">
                            ...
                            @else
                                ...
                                @if (Auth::guard('customer')->check())
                                    <a
                                        href="{{ route('home.top100.registered', ['id_user' => Auth::guard('customer')->user()->id, 'id_top100' => $top100->id]) }}">
