            ...
            <div class="ms-artist-info ">
                <div class="wrapper-artist-info">
                    ...
                    <div class="artist-suggession-play-song">
                        ...
                        @if($checkRegistered)
                        <a href="{{route('home.top100.unregistered',['id_user'=>Auth::guard('customer')->user()->id,'id_top100'=>$top100->id])}}">
                        ...
                        <!--Neu chua dang ki thi kt user dang nhap roi check-->
                            ...
                            <a href="{{route('home.top100.registered',['id_user'=>Auth::guard('customer')->user()->id,'id_top100'=>$top100->id])}}">
