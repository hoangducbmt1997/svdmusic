        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    <td class="text-right">
                            <a href="{{route('admin.artist.edit',$item->id)}}" class="btn btn-edit btn-success">
                                <i class="fas fa-edit "></i>
                            </a>
                            <a href="{{route('admin.artist.destroy',$item->id)}}" class="btn btn-danger btn-delete">
