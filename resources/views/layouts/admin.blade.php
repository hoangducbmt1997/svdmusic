        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{route('home.index')}}" class="nav-link" target="_blank" >Home</a>
                </li>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="dropdown-item" href="{{ route('admin.LoginController.logout') }}" onclick="event.preventDefault();
                                         document.getElementById('logout-form').submit();">
                        {{ __('Logout') }}
                    </a>
                    <form id="logout-form" action="{{ route('admin.LoginController.logout') }}" method="GET" class="d-none">
                        @csrf
                    </form>
